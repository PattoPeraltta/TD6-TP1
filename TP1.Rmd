...
v1 <- flip_labels(entrenamiento_original, 0.05)
entrenamiento_v1 <- v1$data
idx_flip_v1 <- v1$flipped_idx
v2 <- flip_labels(entrenamiento_original, 0.10)
entrenamiento_v2 <- v2$data
idx_flip_v2 <- v2$flipped_idx
v3 <- flip_labels(entrenamiento_original, 0.15)
entrenamiento_v3 <- v3$data
idx_flip_v3 <- v3$flipped_idx
v4 <- flip_labels(entrenamiento_original, 0.20)
entrenamiento_v4 <- v4$data
idx_flip_v4 <- v4$flipped_idx
v5 <- flip_labels(entrenamiento_original, 0.25)
entrenamiento_v5 <- v5$data
idx_flip_v5 <- v5$flipped_idx
v6 <- flip_labels(entrenamiento_original, 0.30)
entrenamiento_v6 <- v6$data
idx_flip_v6 <- v6$flipped_idx
```
...
for (nm in c(
  "entrenamiento_original", "validacion", "testeo",
